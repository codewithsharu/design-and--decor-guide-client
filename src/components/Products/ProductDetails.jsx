            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-2/5 p-4 sm:p-8 bg-gray-50">
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    <h1 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-2">{selectedProduct.name}</h1>
                  ...
                  <div className="border-t border-b py-4">
                    <div className="flex items-baseline gap-4">
                      ...
                      {selectedProduct.originalPrice && (
                        <span className="text-lg sm:text-xl text-gray-500 line-through">₹{selectedProduct.originalPrice}</span>
                      )}
                    </div>
