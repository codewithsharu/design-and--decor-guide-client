...
const UserLayout = () => {
  ...
  // Use a unique class for the scroll-to-top button
  const scrollToTop = () => {
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
  ...
  // Determine if we are on the contactus page
  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <button
          ...
          `}
          style={{
            // Extra fallback for mobile: shrink on small screens for contactus
            ...(isContactUsPage
              ? {
                  width: '40px',
                  height: '40px',
        ...
        {/* Responsive styles for unique-scrolltop-btn */}
        <style>
          {`
